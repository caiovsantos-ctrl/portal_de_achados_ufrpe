...
class Validador:
    ...
    def validar_nome():
        ...
        while True:
            ...
            if Acessorio.verificar_escape(nome):
                Acessorio.limpar_tela()
                return None
            if nome == "":
    ...
    def validar_email():
        ...
        while True:
            ...
            if Acessorio.verificar_escape(email):
                Acessorio.limpar_tela()
                return None
            if email == "":
    ...
    def validar_senha():
        ...
        while True:
            ...
            senha = senha.strip()
            if Acessorio.verificar_escape(senha):
                Acessorio.limpar_tela()
                return None
            if senha == '':
    ...
    def validar_zap():
        ...
        while True:
            ...
            zap = zap.strip()
            if Acessorio.verificar_escape(zap):
                Acessorio.limpar_tela()
                return None
            if zap == '':
    ...
    def confirmar_identidade(user_logado):
        ...
        while True:
            ...
            if confirmar_senha == senha_correta:
                ...
                deseja_continuar = Acessorio.tentar_novamente(mensagem = 'Deseja tentar confirmar sua identidade novamente?[S/N] ')
